...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center">
            ...
            <div className="lg:w-5/12 md:w-5/12 mb-8 animate__animated animate__fadeInLeft">
              <div className="detail-box bg-yellow-200 p-8 rounded-lg shadow-xl transform hover:scale-105 transition-transform duration-300">
                ...
                <p className="text-justify text-gray-700 mb-4 leading-relaxed">
                  ...
                  airport transfers, and more. Our service is committed to your convenience and safety, every mile of
                  the way.
                </p>
                <p className="text-justify text-gray-700 mb-4 leading-relaxed">
                  ...
                  professional drivers and top-notch vehicles. Our goal is to deliver an experience that is comfortable,
                  stress-free, and most importantly, safe.
                </p>
                <p className="text-justify text-gray-700 mb-4 leading-relaxed">
                  Whether you're going on a business trip, family vacation, or a simple airport transfer, Aimcab offers
                  a wide range of vehicles to cater to all your travel needs. With a fleet of well-maintained cars,
                  including sedans and SUVs, we ensure that every ride is a smooth and enjoyable experience.
                </p>
      ...
      {/* Services Section */}
      <section
        className="service_section layout_padding py-16 px-8 bg-gradient-to-r from-yellow-400 to-orange-400"
        id="service"
      >
          ...
          <div className="service_container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
            ...
            <div className="box bg-white p-8 rounded-lg shadow-xl text-center transform transition-all hover:translate-y-[-12px] hover:shadow-2xl hover:duration-300 animate__animated animate__fadeInUp animate__delay-1s">
              ...
              <div className="detail-box">
                <h5 className="text-xl font-semibold text-gray-800 mb-3 hover:text-blue-500 transition-colors">
                  Luxury Cars
                </h5>
            ...
            <div className="box bg-white p-8 rounded-lg shadow-xl text-center transform transition-all hover:translate-y-[-12px] hover:shadow-2xl hover:duration-300 animate__animated animate__fadeInUp animate__delay-1s">
              ...
              <div className="detail-box">
                ...
                <a href="tel:9130030054" className="text-blue-500 underline hover:text-blue-700">
                  Call Us
                </a>
              </div>
            </div>
      ...
      <section className="cta-section bg-gradient-to-r bg-yellow-500 py-16 sm:py-24 w-full">
        <div className="w-full text-center px-4 sm:px-6 lg:px-8 mb-12">
          ...
          <div className="testimonial-box relative bg-yellow-500 py-10 px-6 text-center rounded-lg shadow-2xl mb-12 animate__animated animate__fadeInUp animate__delay-2.5s">
            ...
            <h3 className="text-2xl sm:text-3xl font-bold text-black mb-4">What Our Customers Say</h3>
          ...
          <div className="text-center animate__animated animate__fadeInUp animate__delay-3s">
            <h3 className="text-lg sm:text-xl lg:text-2xl text-white mb-4">Have Questions? We're Here to Help!</h3>
