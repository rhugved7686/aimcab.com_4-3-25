...
export default function PuneToGoaRoute() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-green-500 text-white py-4 text-center">
        <h1 className="text-3xl font-bold">AIMCAB - Pune to Goa Route</h1>
        <p className="mt-2 text-lg">Book your cab for a relaxing and scenic journey from Pune to Goa</p>
      </header>

      {/* Route Information Section */}
      <section className="mt-8 px-4">
        <h2 className="text-2xl font-semibold text-center text-gray-700">Pune to Goa - A Scenic Beach Destination Awaits</h2>
        <div className="mt-6 bg-white p-6 rounded-lg shadow-lg">
          <h3 className="text-xl font-semibold text-green-500">Distance & Duration</h3>
          <p className="text-gray-600 mt-2">The distance between Pune and Goa is approximately 450 kilometers. The journey typically takes around 7 to 9 hours, depending on traffic and road conditions.</p>

          <h3 className="text-xl font-semibold text-green-500 mt-4">Route Highlights</h3>
          <ul className="list-disc list-inside text-gray-600 mt-2">
            <li>Travel through the beautiful Western Ghats with lush green landscapes</li>
            <li>Enjoy picturesque views of beaches and natural beauty as you approach Goa</li>
            <li>Discover Goa’s vibrant culture, stunning beaches, and famous tourist attractions</li>
          </ul>
        </div>
      </section>
      ...
      <section className="mt-16 bg-green-500 text-white py-8 px-4 text-center rounded-lg shadow-lg">
        ...
        <p className="mt-2">Select your preferred vehicle and get ready for a scenic and relaxing journey to Goa.</p>
        <button 
      ...
      <footer className="bg-green-500 text-white py-4 text-center mt-16">
        <p>&copy; 2024 AIMCAB - Your trusted cab service for Pune to Goa</p>
      </footer>
    </div>
  );
}
