...
export default function PuneToDhuleRoute() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-green-500 text-white py-4 text-center">
        <h1 className="text-3xl font-bold">AIMCAB - Pune to Dhule Route</h1>
        <p className="mt-2 text-lg">Book your cab for a comfortable journey from Pune to Dhule, a city rich in culture and history.</p>
      </header>

      {/* Route Information Section */}
      <section className="mt-8 px-4">
        <h2 className="text-2xl font-semibold text-center text-gray-700">Pune to Dhule - A Historic Journey through Maharashtra</h2>
        <div className="mt-6 bg-white p-6 rounded-lg shadow-lg">
          <h3 className="text-xl font-semibold text-green-500">Distance & Duration</h3>
          <p className="text-gray-600 mt-2">The distance between Pune and Dhule is approximately 300 kilometers. The journey typically takes around 5.5 to 7 hours, depending on traffic and road conditions.</p>

          <h3 className="text-xl font-semibold text-green-500 mt-4">Route Highlights</h3>
          <ul className="list-disc list-inside text-gray-600 mt-2">
            <li>Drive through scenic rural landscapes of Maharashtra</li>
            <li>Explore the historical significance of Dhule, with temples and old monuments</li>
            <li>Visit places like the Saptashrungi Fort and Jain temples</li>
          </ul>
        </div>
      </section>
      ...
      <section className="mt-16 bg-green-500 text-white py-8 px-4 text-center rounded-lg shadow-lg">
        ...
        <p className="mt-2">Select your preferred vehicle and get ready for a peaceful ride to Dhule, exploring its history and beauty.</p>
        <button 
      ...
      <footer className="bg-green-500 text-white py-4 text-center mt-16">
        <p>&copy; 2024 AIMCAB - Your trusted cab service for Pune to Dhule</p>
      </footer>
    </div>
  );
}
