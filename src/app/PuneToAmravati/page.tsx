...
export default function PuneToAmravatiRoute() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-green-500 text-white py-4 text-center">
        <h1 className="text-3xl font-bold">AIMCAB - Pune to Amravati Route</h1>
        <p className="mt-2 text-lg">Book your cab for a smooth and scenic journey from Pune to Amravati, a city known for its rich culture and agriculture.</p>
      </header>

      {/* Route Information Section */}
      <section className="mt-8 px-4">
        <h2 className="text-2xl font-semibold text-center text-gray-700">Pune to Amravati - A Journey through Maharashtra</h2>
        <div className="mt-6 bg-white p-6 rounded-lg shadow-lg">
          <h3 className="text-xl font-semibold text-green-500">Distance & Duration</h3>
          <p className="text-gray-600 mt-2">The distance between Pune and Amravati is approximately 550 kilometers. The journey typically takes around 9 to 11 hours, depending on traffic and road conditions.</p>

          <h3 className="text-xl font-semibold text-green-500 mt-4">Route Highlights</h3>
          <ul className="list-disc list-inside text-gray-600 mt-2">
            <li>Scenic drive through the heart of Maharashtra, with views of rural landscapes</li>
            <li>Explore Amravati's cultural heritage, including temples, gardens, and local markets</li>
            <li>Visit famous landmarks such as the Melghat Tiger Reserve and Shri Ekvira Devi Temple</li>
          </ul>
        </div>
      </section>
      ...
      <section className="mt-16 bg-green-500 text-white py-8 px-4 text-center rounded-lg shadow-lg">
        ...
        <p className="mt-2">Select your preferred vehicle and get ready to explore Amravati, a city filled with history and beauty.</p>
        <button 
      ...
      <footer className="bg-green-500 text-white py-4 text-center mt-16">
        <p>&copy; 2024 AIMCAB - Your trusted cab service for Pune to Amravati</p>
      </footer>
    </div>
  );
}
