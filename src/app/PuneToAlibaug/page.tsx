...
export default function PuneToAlibaugRoute() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-green-500 text-white py-4 text-center">
        <h1 className="text-3xl font-bold">AIMCAB - Pune to Alibaug Route</h1>
        <p className="mt-2 text-lg">Book your cab for a relaxing journey from Pune to Alibaug</p>
      </header>

      {/* Route Information Section */}
      <section className="mt-8 px-4">
        <h2 className="text-2xl font-semibold text-center text-gray-700">Pune to Alibaug - A Coastal Getaway</h2>
        <div className="mt-6 bg-white p-6 rounded-lg shadow-lg">
          <h3 className="text-xl font-semibold text-green-500">Distance & Duration</h3>
          <p className="text-gray-600 mt-2">The distance between Pune and Alibaug is approximately 140 kilometers. The journey typically takes around 3 to 4 hours, depending on traffic conditions.</p>

          <h3 className="text-xl font-semibold text-green-500 mt-4">Route Highlights</h3>
          <ul className="list-disc list-inside text-gray-600 mt-2">
            <li>Scenic drive along the western coast of India</li>
            <li>Enjoy lush green landscapes, especially during the monsoon</li>
            <li>Famous beaches like Nagaon and Alibaug Beach</li>
            <li>Visit to historical forts and temples along the way</li>
          </ul>
        </div>
      </section>
      ...
      <section className="mt-16 bg-green-500 text-white py-8 px-4 text-center rounded-lg shadow-lg">
        ...
        <p className="mt-2">Select your preferred vehicle and get ready to enjoy a beautiful ride from Pune to Alibaug.</p>
        <button 
      ...
      <footer className="bg-green-500 text-white py-4 text-center mt-16">
        <p>&copy; 2024 AIMCAB - Your trusted cab service for Pune to Alibaug</p>
      </footer>
    </div>
  );
}
