...
export default function PuneToIndoreRoute() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-green-500 text-white py-4 text-center">
        <h1 className="text-3xl font-bold">AIMCAB - Pune to Indore Route</h1>
        <p className="mt-2 text-lg">Book your cab for a smooth journey from Pune to Indore, the heart of Madhya Pradesh</p>
      </header>

      {/* Route Information Section */}
      <section className="mt-8 px-4">
        <h2 className="text-2xl font-semibold text-center text-gray-700">Pune to Indore - A Journey to the Heart of Madhya Pradesh</h2>
        <div className="mt-6 bg-white p-6 rounded-lg shadow-lg">
          <h3 className="text-xl font-semibold text-green-500">Distance & Duration</h3>
          <p className="text-gray-600 mt-2">The distance between Pune and Indore is approximately 580 kilometers. The journey typically takes around 9 to 11 hours, depending on traffic and road conditions.</p>

          <h3 className="text-xl font-semibold text-green-500 mt-4">Route Highlights</h3>
          <ul className="list-disc list-inside text-gray-600 mt-2">
            <li>Scenic drive through the countryside of Maharashtra and Madhya Pradesh</li>
            <li>Explore the bustling city of Indore, known for its food, culture, and history</li>
            <li>Visit landmarks like Rajwada Palace, Lal Baag, and Kanch Mandir</li>
          </ul>
        </div>
      </section>
      ...
      <section className="mt-16 bg-green-500 text-white py-8 px-4 text-center rounded-lg shadow-lg">
        ...
        <p className="mt-2">Select your preferred vehicle and get ready to experience the rich culture and food of Indore.</p>
        <button 
      ...
      <footer className="bg-green-500 text-white py-4 text-center mt-16">
        <p>&copy; 2024 AIMCAB - Your trusted cab service for Pune to Indore</p>
      </footer>
    </div>
  );
}
