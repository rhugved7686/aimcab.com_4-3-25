...
export default function PuneToBangaloreRoute() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-green-500 text-white py-4 text-center">
        <h1 className="text-3xl font-bold">AIMCAB - Pune to Bangalore Route</h1>
        <p className="mt-2 text-lg">Book your cab for a comfortable journey from Pune to the vibrant city of Bangalore</p>
      </header>

      {/* Route Information Section */}
      <section className="mt-8 px-4">
        <h2 className="text-2xl font-semibold text-center text-gray-700">Pune to Bangalore - A Journey to the Garden City</h2>
        <div className="mt-6 bg-white p-6 rounded-lg shadow-lg">
          <h3 className="text-xl font-semibold text-green-500">Distance & Duration</h3>
          <p className="text-gray-600 mt-2">The distance between Pune and Bangalore is approximately 840 kilometers. The journey typically takes around 12 to 14 hours, depending on traffic and road conditions.</p>

          <h3 className="text-xl font-semibold text-green-500 mt-4">Route Highlights</h3>
          <ul className="list-disc list-inside text-gray-600 mt-2">
            <li>Travel through scenic highways, including the NH48, with picturesque landscapes</li>
            <li>Explore the vibrant city of Bangalore, known for its parks, lakes, and IT hub</li>
            <li>Visit landmarks like Lalbagh Botanical Garden, Cubbon Park, and Bangalore Palace</li>
          </ul>
        </div>
      </section>
      ...
      <section className="mt-16 bg-green-500 text-white py-8 px-4 text-center rounded-lg shadow-lg">
        ...
        <p className="mt-2">Select your preferred vehicle and get ready to explore Bangalore's vibrant culture and green spaces.</p>
        <button 
      ...
      <footer className="bg-green-500 text-white py-4 text-center mt-16">
        <p>&copy; 2024 AIMCAB - Your trusted cab service for Pune to Bangalore</p>
      </footer>
    </div>
  );
}
