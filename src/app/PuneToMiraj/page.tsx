...
export default function PuneToMirajRoute() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-green-500 text-white py-4 text-center">
        <h1 className="text-3xl font-bold">AIMCAB - Pune to Miraj Route</h1>
        <p className="mt-2 text-lg">Book your cab for a comfortable and scenic journey from Pune to Miraj</p>
      </header>

      {/* Route Information Section */}
      <section className="mt-8 px-4">
        <h2 className="text-2xl font-semibold text-center text-gray-700">Pune to Miraj - A Journey through the Heart of Maharashtra</h2>
        <div className="mt-6 bg-white p-6 rounded-lg shadow-lg">
          <h3 className="text-xl font-semibold text-green-500">Distance & Duration</h3>
          <p className="text-gray-600 mt-2">The distance between Pune and Miraj is approximately 250 kilometers. The journey typically takes around 5 to 6 hours, depending on traffic and road conditions.</p>

          <h3 className="text-xl font-semibold text-green-500 mt-4">Route Highlights</h3>
          <ul className="list-disc list-inside text-gray-600 mt-2">
            <li>Drive through scenic landscapes and peaceful towns of Maharashtra</li>
            <li>Discover the cultural significance of Miraj, known for its historical temples and musical heritage</li>
            <li>Enjoy the diverse beauty of the rural countryside along the way</li>
          </ul>
        </div>
      </section>
      ...
      <section className="mt-16 bg-green-500 text-white py-8 px-4 text-center rounded-lg shadow-lg">
        ...
        <p className="mt-2">Select your preferred vehicle and get ready for a smooth and enjoyable journey to Miraj.</p>
        <button 
      ...
      <footer className="bg-green-500 text-white py-4 text-center mt-16">
        <p>&copy; 2024 AIMCAB - Your trusted cab service for Pune to Miraj</p>
      </footer>
    </div>
  );
}
