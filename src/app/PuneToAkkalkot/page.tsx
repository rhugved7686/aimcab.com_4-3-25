...
export default function PuneToAkkalkotRoute() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-green-500 text-white py-4 text-center">
        <h1 className="text-3xl font-bold">AIMCAB - Pune to Akkalkot Route</h1>
        <p className="mt-2 text-lg">Book your cab for a comfortable journey from Pune to Akkalkot, a town known for its religious significance and historical temples.</p>
      </header>

      {/* Route Information Section */}
      <section className="mt-8 px-4">
        <h2 className="text-2xl font-semibold text-center text-gray-700">Pune to Akkalkot - A Spiritual Journey</h2>
        <div className="mt-6 bg-white p-6 rounded-lg shadow-lg">
          <h3 className="text-xl font-semibold text-green-500">Distance & Duration</h3>
          <p className="text-gray-600 mt-2">The distance between Pune and Akkalkot is approximately 300 kilometers. The journey typically takes around 6 to 7 hours, depending on traffic and road conditions.</p>

          <h3 className="text-xl font-semibold text-green-500 mt-4">Route Highlights</h3>
          <ul className="list-disc list-inside text-gray-600 mt-2">
            <li>Scenic drive through the rural landscapes of Maharashtra</li>
            <li>Visit the famous Akkalkot Swami Samarth Temple, a major pilgrimage site</li>
            <li>Explore the spiritual and historical significance of Akkalkot</li>
          </ul>
        </div>
      </section>
      ...
      <section className="mt-16 bg-green-500 text-white py-8 px-4 text-center rounded-lg shadow-lg">
        ...
        <p className="mt-2">Select your preferred vehicle and get ready for a peaceful and spiritual journey to Akkalkot, known for its religious significance and the Swami Samarth Temple.</p>
        <button 
      ...
      <footer className="bg-green-500 text-white py-4 text-center mt-16">
        <p>&copy; 2024 AIMCAB - Your trusted cab service for Pune to Akkalkot</p>
      </footer>
    </div>
  );
}
