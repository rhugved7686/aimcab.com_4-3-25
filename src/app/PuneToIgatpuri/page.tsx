...
export default function PuneToIgatpuriRoute() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-green-500 text-white py-4 text-center">
        <h1 className="text-3xl font-bold">AIMCAB - Pune to Igatpuri Route</h1>
        <p className="mt-2 text-lg">Book your cab for a scenic journey from Pune to Igatpuri</p>
      </header>

      {/* Route Information Section */}
      <section className="mt-8 px-4">
        <h2 className="text-2xl font-semibold text-center text-gray-700">Pune to Igatpuri - A Picturesque Journey</h2>
        <div className="mt-6 bg-white p-6 rounded-lg shadow-lg">
          <h3 className="text-xl font-semibold text-green-500">Distance & Duration</h3>
          <p className="text-gray-600 mt-2">The distance between Pune and Igatpuri is approximately 120 kilometers. The journey typically takes around 2.5 to 3 hours, depending on traffic conditions.</p>
          ...
          <ul className="list-disc list-inside text-gray-600 mt-2">
            ...
            <li>Comfortable highway and mountain road drive</li>
            <li>Popular stopover at Kasara Ghat for breathtaking views</li>
          </ul>
        </div>
      </section>
      ...
      <section className="mt-16 bg-green-500 text-white py-8 px-4 text-center rounded-lg shadow-lg">
        ...
        <p className="mt-2">Select your preferred vehicle and get ready for an unforgettable ride from Pune to Igatpuri.</p>
        <button
      ...
      <footer className="bg-green-500 text-white py-4 text-center mt-16">
        <p>&copy; 2024 AIMCAB - Your trusted cab service for Pune to Igatpuri</p>
      </footer>
    </div>
  );
}
