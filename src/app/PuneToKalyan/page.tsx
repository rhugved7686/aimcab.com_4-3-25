...
export default function PuneToKalyanRoute() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-green-500 text-white py-4 text-center">
        <h1 className="text-3xl font-bold">AIMCAB - Pune to Kalyan Route</h1>
        <p className="mt-2 text-lg">Book your cab for a smooth and convenient journey from Pune to Kalyan</p>
      </header>

      {/* Route Information Section */}
      <section className="mt-8 px-4">
        <h2 className="text-2xl font-semibold text-center text-gray-700">Pune to Kalyan - A Pleasant Ride</h2>
        <div className="mt-6 bg-white p-6 rounded-lg shadow-lg">
          <h3 className="text-xl font-semibold text-green-500">Distance & Duration</h3>
          <p className="text-gray-600 mt-2">The distance between Pune and Kalyan is approximately 160 kilometers. The journey typically takes around 3 to 4 hours, depending on traffic conditions.</p>

          <h3 className="text-xl font-semibold text-green-500 mt-4">Route Highlights</h3>
          <ul className="list-disc list-inside text-gray-600 mt-2">
            <li>Travel through the scenic Mumbai-Pune Expressway</li>
            <li>Pass through beautiful landscapes of the Western Ghats</li>
            <li>Visit the popular temples and local attractions in Kalyan</li>
          </ul>
        </div>
      </section>
      ...
      <section className="mt-16 bg-green-500 text-white py-8 px-4 text-center rounded-lg shadow-lg">
        ...
        <p className="mt-2">Select your preferred vehicle and enjoy a smooth ride from Pune to Kalyan.</p>
        <button 
      ...
      <footer className="bg-green-500 text-white py-4 text-center mt-16">
        <p>&copy; 2024 AIMCAB - Your trusted cab service for Pune to Kalyan</p>
      </footer>
    </div>
  );
}
