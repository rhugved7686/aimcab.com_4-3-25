...
export default function PuneToKhandalaRoute() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-green-500 text-white py-4 text-center">
        <h1 className="text-3xl font-bold">AIMCAB - Pune to Khandala Route</h1>
        <p className="mt-2 text-lg">Book your cab for a smooth and scenic journey from Pune to Khandala</p>
      </header>

      {/* Route Information Section */}
      <section className="mt-8 px-4">
        <h2 className="text-2xl font-semibold text-center text-gray-700">Pune to Khandala - A Scenic Getaway</h2>
        <div className="mt-6 bg-white p-6 rounded-lg shadow-lg">
          <h3 className="text-xl font-semibold text-green-500">Distance & Duration</h3>
          <p className="text-gray-600 mt-2">The distance between Pune and Khandala is approximately 65 kilometers. The journey typically takes around 1.5 to 2 hours, depending on traffic conditions.</p>

          <h3 className="text-xl font-semibold text-green-500 mt-4">Route Highlights</h3>
          <ul className="list-disc list-inside text-gray-600 mt-2">
            <li>Picturesque views of the Western Ghats</li>
            <li>Popular hill station with lush greenery and cool climate</li>
            <li>Famous for the scenic Khandala Ghat</li>
            <li>Multiple stop options for refreshments and sightseeing</li>
          </ul>
        </div>
      </section>
      ...
      <section className="mt-16 bg-green-500 text-white py-8 px-4 text-center rounded-lg shadow-lg">
        ...
        <p className="mt-2">Select your preferred vehicle and enjoy a scenic ride to Khandala.</p>
        <button
      ...
      <footer className="bg-green-500 text-white py-4 text-center mt-16">
        <p>&copy; 2024 AIMCAB - Your trusted cab service for Pune to Khandala</p>
      </footer>
    </div>
  );
}
