      ...
      <div className="container mx-auto px-4 text-center sm:text-right mt-6">
        <span className="flex justify-center sm:justify-end">
          <a href="https://wa.me/9130030054" target="_blank">
            <img className="w-8 h-8 inline-block mx-2 mb-2 sm:mb-0" src="images/whatsapp.png" alt="WhatsApp" />
          </a>
          <a href="https://www.facebook.com/Aimcab" target="_blank">
            <img className="w-8 h-8 inline-block mx-2 mb-2 sm:mb-0" src="images/facebook.png" alt="Facebook" />
          </a>
          <a href="https://www.youtube.com/@AimCab" target="_blank">
            <img className="w-8 h-8 inline-block mx-2 mb-2 sm:mb-0" src="images/youtube.png" alt="YouTube" />
          </a>
          <a href="https://twitter.com/aim_cab" target="_blank">
            <img className="w-8 h-8 inline-block mx-2 mb-2 sm:mb-0" src="images/twitter.png" alt="Twitter" />
          </a>
          <a href="https://www.linkedin.com/in/aim-cab-77356b208/" target="_blank">
            <img className="w-8 h-8 inline-block mx-2 mb-2 sm:mb-0" src="images/linked-in.png" alt="LinkedIn" />
          </a>
          <a href="https://join.skype.com/invite/sRT2FTyb7d1H" target="_blank">
            <img className="w-8 h-8 inline-block mx-2 mb-2 sm:mb-0" src="images/skype.png" alt="Skype" />
          </a>
          <a href="https://www.instagram.com/aimcabs/" target="_blank">
            <img className="w-8 h-8 inline-block mx-2 mb-2 sm:mb-0" src="images/instagram.png" alt="Instagram" />
          </a>
        </span>
      </div>
    </div>
